...
WebUI.click(findTestObject('Object Repository/Page_Your store. Login/form_Welcome, please sign inEmailPasswordRe_87c0f5'))
...
WebUI.verifyTextPresent('ABC', true, FailureHandling.OPTIONAL)
